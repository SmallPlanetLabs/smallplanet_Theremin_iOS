...
+ (NSArray *)keyStrings {
    return @[kKeyAMinor, kKeyAMajor, kKeyBMinor, kKeyBMajor, kKeyBMinor, kKeyCMajor, kKeyDMinor, kKeyDMajor, kKeyEMinor, kKeyEMajor, kKeyFMajor, kKeyGMinor, kKeyGMajor, kKeyChromatic];
}
