...
-(id)init{
    ...
    if(self){
        ...
        _synthesizer = [[VWWSynthesizer alloc]initWithAmplitude:_amplitude frequencyLeft:_frequency frequencyRight:_frequency];
...
-(void)setFrequency:(float)newFrequency{
    ...
    self.synthesizer.frequencyLeft = _frequency;
    self.synthesizer.frequencyRight = _frequency;
